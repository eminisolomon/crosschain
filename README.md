...
[![Build](https://img.shields.io/github/actions/workflow/status/eminisolomon/cryptochain/main.yml)](https://github.com/eminisolomon/cryptochain)
[![Version](https://img.shields.io/npm/v/cryptochain)](https://github.com/eminisolomon/cryptochain)
[![GitHub issues](https://img.shields.io/github/issues/eminisolomon/cryptochain)](https://github.com/eminisolomon/cryptochain/issues)
[![GitHub stars](https://img.shields.io/github/stars/eminisolomon/cryptochain)](https://github.com/eminisolomon/cryptochain/stargazers)
[![GitHub license](https://img.shields.io/github/license/eminisolomon/cryptochain)](https://github.com/eminisolomon/cryptochain)
[![Total Downloads](https://img.shields.io/npm/dm/cryptochain)](https://github.com/eminisolomon/cryptochain)

## Installation

```bash
npm install cryptochain
```

Using yarn,

```bash
yarn add cryptochain
```
...
```javascript
const multichainWallet = require('cryptochain');
```

### TypeScript

```typescript
import * as multichainWallet from 'cryptochain';
```
